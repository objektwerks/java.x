...
CREATE INDEX FK3D2B86CD4D08498A_INDEX_5 ON ASSIGNMENT ( TEACHER_ID );
CREATE TABLE COURSE
(
    ID BIGINT PRIMARY KEY NOT NULL,
...
(
    ...
    FOREIGN KEY ( ASSIGNMENTS_ID ) REFERENCES ASSIGNMENT ( ID ),
    FOREIGN KEY ( COURSE_ID ) REFERENCES COURSE ( ID )
);
CREATE INDEX FK51F76D712F361ACA_INDEX_E ON COURSE_ASSIGNMENT ( COURSE_ID );
CREATE TABLE GRADE
(
    ID BIGINT PRIMARY KEY NOT NULL,
    END DATE NOT NULL,
...
CREATE INDEX FK5E0BFD7FA88B02A_INDEX_4 ON GRADE ( SCHOOL_ID );
...
CREATE INDEX FK2D69ED833E124D6A_INDEX_5 ON GRADE_COURSE ( GRADE_ID );
CREATE TABLE SCHOOL
(
    ID BIGINT PRIMARY KEY NOT NULL,
    NAME VARCHAR(64) NOT NULL,
...
CREATE INDEX FKDCA1CCD33C6CFEEA_INDEX_C ON STUDENT_GRADE ( STUDENT_ID );
